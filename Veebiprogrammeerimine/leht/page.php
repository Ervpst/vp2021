...
<img src="3700x1100 pildivalik187.jpg" alt="Tallina Ülikooli Terra õppehoone" width="600">
<p>Lehe avamise hetkel: <span><?php echo $weekday_names_et[$weekday_now - 1] .", ". $full_time_now .", on" .$day_category; ?></span>.</p>
